...
1.  [Install](../Managing_Plugins_2.md#installing-a-plugin) the Dropbox plugin
...
Security Settings
----------------------------------------------------------------
It may be necessary to add specific mimetypes to the Allowed File Types in the admin section. See [Managing Security Settings](../Managing_Security_Settings_2.md) for more information.
