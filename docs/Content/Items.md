...
![Screenshot of the Add Item screen](../doc_files/itemAdd.png)
...
1.  The **Tags** tab allows you add keyword tags to your item.
    - Remember to press the “Add Tags” button to attach them to the item.
...
Be sure to click the "Add Item" button to save your work. You cannot save a draft of an item, but you can make it private if you want to edit it further before sharing it publicly.
...
For more information, see the [Using the HTML Editor](Using_HTML_Editor-TinyMCE.md) page.
...
To sort by public, private, or featured items, click the Quick Filter link at the top of the table.
...
![A closer look at the table on the Browse Items page](../doc_files/itemsBrowsePF.png)
...
![A teal arrow points to the Edit link for an item](../doc_files/itemEditlink.png)
...
![The item add/edit window](../doc_files/itemEdit.png)
...
![The Batch Edit window](../doc_files/BatchEdit.png)
