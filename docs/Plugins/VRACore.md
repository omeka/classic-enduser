...
![VRA Core elements in the Element Sets page](../doc_files/plugin_images/VraCore_elementSet.png)
...
![VRA Core configuration options](../doc_files/plugin_images/VraCore_config.png)
...
![Edit item with VRA Core tab highlighted](../doc_files/plugin_images/VraCore_editItem.png)
...
![Example element showing the attribution functions](../doc_files/plugin_images/VraCore_display.png)
...
![Example element showing notes and attirbution elements.](../doc_files/plugin_images/VraCore_notesElements.png)

## Uninstall

While you can uninstall VRA Core like any other plugin, doing so **will not remove the VRA Core elements** from your Omeka site. Metadata stored in VRA Core fields will remain attached to your items. The VRA Core tab will still be available when editing items. 
