...
The Simple Page browse has two views: list view (default) and hierarchy. 
...
On the "Add Page" screen you can enter:
...
Edit any page by going to the "Simple Pages" sidebar entry and clicking "Edit" under the page title. (Note that clicking the title will take you to the public view of that page.)

When you view the details of a page, there are additional options below the "Save Changes" button: 
