...
*Entities* displays a table of named entities in the text, with columns for entity, type, sentiment, count, and relevance. A glossary above the table defines each column.

![Entities table for Pride and Prejudice text sample](../doc_files/plugin_images/ta_entities.png)
...
*Categories* applies the NLU [categories](https://www.ibm.com/watson/developercloud/doc/natural-language-understanding/categories.html) to your content.
