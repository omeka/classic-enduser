...
-   <div id="pt-login">
    ...
    [Log
    In](http://omeka.org/c/index.php?title=Special:UserLogin&returnto=Functions/get%20item%20by%20id)
...
Retrieved from
"[http://omeka.org/codex/Functions/get\_item\_by\_id](get_item_by_id.html)"
