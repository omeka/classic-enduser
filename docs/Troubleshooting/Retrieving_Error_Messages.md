...
1. Go into the files for your Omeka installation on your server. You might do this using FTP, a file manager from your hosting service, or SSH. 
...
If you'd prefer not to have your error messages publicly displayed on your site, you can instead activate error logging. Activating error logging will log any errors encountered by Omeka to a file in the `application/log` directory of your Omeka installation. You can then post the contents to the forum.
