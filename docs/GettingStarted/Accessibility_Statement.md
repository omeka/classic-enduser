...
Please review the [current list of issues](https://github.com/omeka/Omeka/issues?q=is%3Aissue%20state%3Aopen%20label%3Aa11y) in the github repository for the core software.
