...
![Item Type Elements tab with Description field of Text element highlighted](../../doc_files/itemTypeElmEdit.png)

Enter information about the item type element here. This description will accompany any Item Type utilizing the metadata field you have just edited. Don't forget to click "Save Changes" when you have finished.
...
![A screenshot of an item's Item Type Metadata tag](../../doc_files/itemTypeElmShow.png)
